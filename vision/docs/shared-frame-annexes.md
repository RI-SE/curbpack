...
Companion to [`shared-frame.md`](shared-frame.md). Pinned to `RI-SE/curbpack@a36aeef`, method 1.3.0, 27 Aug 2026.
...
| C5 | **`edges` writer-adapter**, both sides. CTAM export **RUNNABLE**; curbpack W7 ingest shipped (`review --repo --json --edges`). E2E round-trip still partner-led. **This is the reservation clock** — the field is deleted at product release v0.6.0 if unused end-to-end (`docs/internal/edges-reservation-expiry.md`) | The only hard deadline | — |
...
| Claim | Status |
|---|---|
| Main `a36aeef` (PR #31), method `1.3.0`, classifier `refclass:2` | **VERIFIED** — merge SHA pin after v6 land, 27 Aug 2026 |
| Prior tip `eac1ab3`, method `1.2.0`, classifier `refclass:1` | **HISTORICAL** — pre-v6 tip; superseded by `a36aeef` |
