...
(Partial; review caps exist, evaluator-wide budgets do not). [CR-11](../../docs2/testing/procedures/2_code_review_procedures.md)
...
evaluator-wide budgets do not). [CR-11](../../docs2/testing/procedures/2_code_review_procedures.md)
remains an independent review activity; a pass on this case would not close it.
...
exist, evaluator-wide budgets do not). [CR-11](../../docs2/testing/procedures/2_code_review_procedures.md)
remains an independent review activity; a pass on this case would not close it.
...
[EC-08](../../docs2/testing/procedures/README.md#execution-configurations) is not yet specified.
