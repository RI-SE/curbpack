...
| **v0.5.4 first-run honesty** | **Shipped** — [RI-SE release v0.5.4](https://github.com/RI-SE/curbpack/releases/tag/v0.5.4) on tip `7f3d5db`; tag-smoke `CURBPACK_VERSION=v0.5.4` passed; `main` advertises **v0.5.4** after this bump. Playbook: [release-v0.5.4.md](../getting-started/release-v0.5.4.md). Action pin still **`@v0.5.2`**. **A2 / A3 still HUMAN**. |
