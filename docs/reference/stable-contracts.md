...
| Method | `method_id` = `curbpack-review-method`; tip `method_version` = **1.3.0** ([`docs/method/review-method-1.3.0.md`](../../vision/docs/method/review-method-1.3.0.md)); must equal `review.MethodVersion` |
