...
func usage() {
	...
	fmt.Fprintf(os.Stderr, "  review --repo [path] [--packs a,b] [--json] [--full] [--since <prior.json>]\n")
	fmt.Fprintf(os.Stderr, "                                Repository-mode ProsePaths triage (cold default house-policy)\n")
