...
// Art14RelPath is the single in-repo Art 14 rehearsal file fix --art14 writes.
func Art14RelPath() string { return art14RelPath }

// Art14PathBody returns product-specific Art 14 rehearsal prose (not DefaultScaffoldBody).
...
Vulnerability handling and public security contact for ` + product + ` are documented separately. They sit on a later clock than Article 14 reporting and are not this rehearsal.
