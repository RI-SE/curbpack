...
- Repository state: [R1](../procedures/0_controlled_repo_setup.md#r1) — prepared by `setup.sh` in step 3. The later `chmod` does not create a new R-id. The text of `SECURITY.md` is still R1. Only the permission bits change.
- Pack input: [PF-01](../procedures/1_pack_template_instantiation.md#pf-01) — selected by `verification-run.sh` through `CURBPACK_PACKS_DIR`.
- Execution configuration: [EC-01](../procedures/0_controlled_repo_setup.md#ec-01) — established and verified by steps 3–4. After step 6 the working tree is no longer EC-01. That is expected. Git cannot hash an unreadable `SECURITY.md`.
...
channel required by MUST-23. See [REG-SKIP-01](../../software-design-document.md#reg-skip-01).
A pass on this case does not close MUST-23.

### SETUP

- Repository state: [R1](../procedures/0_controlled_repo_setup.md#r1) — prepared by `setup.sh` in step 3. Step 6 adds `docs/ev005-skip.md`. That file is stimulus, not a new R-id.
- Pack input: [PF-01](../procedures/1_pack_template_instantiation.md#pf-01) — selected by `verification-run.sh` through `CURBPACK_PACKS_DIR`.
- Execution configuration: [EC-01](../procedures/0_controlled_repo_setup.md#ec-01) — established and verified by steps 3–4. After step 6 the working tree is dirty.
...
- Repository state: [R4](../procedures/0_controlled_repo_setup.md#r4) — prepared by `setup.sh` in step 3.
...
| ------- | ---------- | --------- | ---------------------- |
| A | `file_present` | `HOUSE-SECURITY-MD` | [R2](../procedures/0_controlled_repo_setup.md#r2) |
| B | `annex_file` | `MD-SW-CLASS` | [R3](../procedures/0_controlled_repo_setup.md#r3) |
| C | `anti_placeholder` | `HOUSE-ANTI-PLACEHOLDER` | [R4](../procedures/0_controlled_repo_setup.md#r4) |
...
| G | `fresh` | `FIX-FRESH-REVIEW` | [R6](../procedures/0_controlled_repo_setup.md#r6) |
| H | `owned` | `FIX-OWNED-POLICY` | [R7](../procedures/0_controlled_repo_setup.md#r7) |
...
- Repository state: [R1](../procedures/0_controlled_repo_setup.md#r1) — prepared by `setup.sh` in step 3. Step 5 adds a banned axios pin. That edit is stimulus, not a new R-id.
- Pack input: `house-policy` only (`--packs house-policy`). No PF-id.
- Execution configuration: [EC-01](../procedures/0_controlled_repo_setup.md#ec-01) for steps 3–4. After step 5 the working tree is dirty ([EC-02](../procedures/README.md#execution-configurations)).
...
- Repository state: [R1](../procedures/0_controlled_repo_setup.md#r1) — prepared by `setup.sh` in step 3. Step 5 appends PEM marker lines to `SECURITY.md`. That edit is stimulus, not a new R-id. The marker is fixture text only.
- Pack input: `house-policy` only (`--packs house-policy`). No PF-id.
- Execution configuration: [EC-01](../procedures/0_controlled_repo_setup.md#ec-01) for steps 3–4. After step 5 the working tree is dirty ([EC-02](../procedures/README.md#execution-configurations)).
...
- Repository state: [R6](../procedures/0_controlled_repo_setup.md#r6) — prepared by `setup.sh` in step 3.
- Pack input: [PF-07](../procedures/1_pack_template_instantiation.md) (`fresh-owned-test`). Selected by SETUP step 7. Not an R-id.
- Execution configuration: [EC-01](../procedures/0_controlled_repo_setup.md#ec-01) — established and verified by the setup steps below.
...
- Repository state: [R7](../procedures/0_controlled_repo_setup.md#r7) — prepared by `setup.sh` in step 3.
- Pack input: [PF-07](../procedures/1_pack_template_instantiation.md) (`fresh-owned-test`). Selected by SETUP step 7. Not an R-id.
- Execution configuration: [EC-01](../procedures/0_controlled_repo_setup.md#ec-01) — established and verified by the setup steps below.
...
- [PF-08](../procedures/1_pack_template_instantiation.md) (`EV008-ALPHA` then `EV008-BETA`)
- [PF-09](../procedures/1_pack_template_instantiation.md) (`EV008-BETA` then `EV008-ALPHA`)
...
- Repository state: [R1](../procedures/0_controlled_repo_setup.md#r1) — prepared by `setup.sh` in step 3.
- Pack input: [PF-08](../procedures/1_pack_template_instantiation.md). Selected by SETUP step 5. Not an R-id.
- Execution configuration: [EC-01](../procedures/0_controlled_repo_setup.md#ec-01) — established and verified by the setup steps below.
...
Repeat SETUP steps 1–4 on a newly sourced restore. Then `./external_test/curbpack/mutate_pack.sh PF-09` and repeat SETUP step 6. Do not reuse the pack-A checkout. Pack input is [PF-09](../procedures/1_pack_template_instantiation.md).
...
- Repository state: [R5](../procedures/0_controlled_repo_setup.md#r5) — prepared by `setup.sh` in step 3.
- Pack input: `house-policy` only (`--packs house-policy`). No PF-id.
- Execution configuration: [EC-01](../procedures/0_controlled_repo_setup.md#ec-01) — established and verified by the setup steps below.
