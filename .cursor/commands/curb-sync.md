...
If the user asks to **enable the curbpack site on RI-SE**, ensure GitHub Pages Source is **GitHub Actions** on `RI-SE/curbpack` (API or Settings → Pages), then dispatch `.github/workflows/pages.yml` there. Primary public URL: `https://ri-se.github.io/curbpack/` (optional mirror: `https://afelin.github.io/curbpack/`).
