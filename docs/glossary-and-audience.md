...
|------|---------------------|
| **CE** | *Conformité Européenne* marking — legal market-access marking for covered products. Curbpack does **not** issue CE marks or complete CE procedures. |
...
| **SBOM** | Software Bill of Materials — inventory of components (e.g. CycloneDX). Curbpack may emit best-effort SBOM drafts from lockfiles. |
...
| **GRC** | Governance, Risk, and Compliance — typically SaaS platforms. Curbpack is local-first evidence, not a GRC suite. |
...
| **Notified body** | Independent organization designated for certain conformity assessment tasks under EU product rules. Curbpack does **not** replace a notified body. |
| **Conformity assessment** | Formal process to show a product meets legal requirements. Curbpack prepares structural evidence for humans — it does **not** perform conformity assessment. |
