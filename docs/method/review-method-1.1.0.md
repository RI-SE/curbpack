# Curbpack review method 1.1.0

**Dated / frozen:** 2026-08-26  
**Method id:** `curbpack-review-method`  
**Method version:** `1.1.0` (must equal `review.MethodVersion` in code)
...
Retains [`review-method-1.0.0.md`](review-method-1.0.0.md) for historical comparison records.
...
Caller supplies triage surfaces (CLI: governed documentation targets from composed packs). Pack-layer structure/load/digest checks are skipped. Missing governed surfaces emit `structure:surface-absent:<path>` (unconfirmed/producer).
