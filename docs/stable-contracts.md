...
| Reserved | An optional `edges` array is **reserved and not implemented**. Do not repurpose the name. **Expires at method/product v1.2.0 if still unused** (delete the reservation rather than leave folklore). Calendar: [edges v1.2.0](internal/edges-v1.2.0-calendar.md) |
