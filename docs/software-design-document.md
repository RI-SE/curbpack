...
|---|---:|---|
| `false_green_paths_open` | 0 | **4 open** |
...
| `channel_parity_failures` | 0 | Failing: skip/cache paths |
...
identified a separate chain-verification path. FG-07, FG-04, and FG-01 are closed;
four false-green paths remain.
