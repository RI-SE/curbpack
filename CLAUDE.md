...
Same contract as [AGENTS.md](AGENTS.md). Design intent: [docs/software-design-document.md](docs/software-design-document.md). Full platform matrix + memory map: [agents/assistant-loop.md](agents/assistant-loop.md). Warm-start: [docs/getting-started/pathway.md](docs/getting-started/pathway.md).
