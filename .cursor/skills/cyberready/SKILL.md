---
description: Run CyberReady+ local compliance gates and explain GateFailure JSON. Use when the user asks about pack gates, prepare-release review packs, or cyberready check/validate/ask/attest. Propose-only — never claim certification.
---
...
3. `ask --propose` suggests edits only; apply changes in the editor, then re-check.
