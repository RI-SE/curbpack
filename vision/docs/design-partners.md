...
Also mirrored in [launch readiness](internal/launch-readiness.md), [Intent vs Scope](intent-vs-scope.md), and [Promotion firewall](../../policies/promotion-firewall.md).
