...
- Pack input: [PF-10](../procedures/1_pack_template_instantiation.md) — selected by SETUP step 2.
...
- Repository state: no R-id. Disposable reference-product checkout after `verification-run.sh`.
- Pack input: [PF-11](../procedures/1_pack_template_instantiation.md) — selected by SETUP step 2.
- Execution configuration: no EC-id.
...
- Repository state: no R-id. Disposable reference-product checkout after `verification-run.sh`.
- Pack input: [PF-12](../procedures/1_pack_template_instantiation.md) — selected by SETUP step 2.
- Execution configuration: no EC-id.
