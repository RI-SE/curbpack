...
func usage() {
	...
	fmt.Fprintf(os.Stderr, "  review --repo [path]  In-repo governed-doc triage (default path: .)\n")
	...
	fmt.Fprintf(os.Stderr, "  review --repo [path] [--json] [--full] [--since <prior.json>]\n")
	fmt.Fprintf(os.Stderr, "                                Repository-mode triage of governed docs (default path: .)\n")
