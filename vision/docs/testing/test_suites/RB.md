...
this case. See INV-06 in [SDD §8](../../software-design-document.md)
(Partial; review caps exist, evaluator-wide budgets do not). [CR-11](../procedures/2_code_review_procedures.md)
...
[SDD §8](../../software-design-document.md) (Partial; review caps exist,
evaluator-wide budgets do not). [CR-11](../procedures/2_code_review_procedures.md)
remains an independent review activity; a pass on this case would not close it.
...
INV-06 in [SDD §8](../../software-design-document.md) (Partial; review caps
exist, evaluator-wide budgets do not). [CR-11](../procedures/2_code_review_procedures.md)
remains an independent review activity; a pass on this case would not close it.
...
[SDD §8](../../software-design-document.md) (Failing). SDD §8 records that
...
[EC-08](../procedures/README.md#execution-configurations) is not yet specified.
