...
Curbpack prepares structural evidence for product repos. Pair it with SCA (e.g. Trivy/OSV) and secret scanners (e.g. Gitleaks) for depth. Explicitly: **not** a security program; watchlist∩SBOM is look-here only — not a CVE product.
